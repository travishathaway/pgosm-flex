...
-- Topic: building
--
-- Tables: building_point, building_polygon
--
-- ---------------------------------------------------------------------------
...
themepark:add_table({
    ...
    ids_type = 'node',
    geom = 'point',
    columns = themepark:columns('core/name', building_cols),
    indexes = {
...
themepark:add_proc('node', function(object, data)
    ...
    themepark:insert('building_point', a)
end)
...
themepark:add_proc('way', function(object, data)
    ...
    themepark:insert('building_polygon', a)
end)
